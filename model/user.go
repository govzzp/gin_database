...
type Depart struct {
	...
	DepartCode string `gorm:"type:varchar(50);index;unique;not null" json:"departcode"`
	DepartName string `grom:"type:varchar(255);" json:"departname"`
}
type Book struct {
	gorm.Model
...
type UserInfos struct {
	...
	Salt      string `gorm:"type:varchar(100);" json:"salt"`                        //加盐
